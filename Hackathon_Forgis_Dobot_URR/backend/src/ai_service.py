...
class AIService:
    ...
    def __init__(self):
        ...
        self._text_model_name = os.environ.get("GEMINI_ORCHESTRATOR_MODEL", DEFAULT_ORCHESTRATOR_MODEL)
        self._vision_model_name = os.environ.get("GEMINI_ER_MODEL", DEFAULT_ER_MODEL)
    ...
    async def generate_text(self, prompt: str, system_instruction: Optional[str] = None) -> str:
        ...
        try:
            ...
            if system_instruction:
                model = genai.GenerativeModel(self._text_model_name, system_instruction=system_instruction)
